...
function msdlab_news_recents_aggregated(){
    ...
    add_action('genesis_entry_footer','msdlab_full_article');
...
function msdlab_full_article(){
    global $post;
    print '<a data-post-id="post-'.$post->ID.'" class="expand-switch"><i class="fa fa-expand"><span class="screen-reader-text">Expand</span></i></a>';
}
